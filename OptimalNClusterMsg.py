...
def BestCentroid(file_number, SVD, start=10, stop=50, step=1):
    ...
    for v in file_number:
        with open(f'/home/ATLAS-T3/eferri/File/DataSet/data-set-frontend-202003{v}-{SVD}-msg.csv') as file_name:
        ...
        np.savetxt(f'/home/ATLAS-T3/eferri/File/BestCentroid/frontend-202003{v}-{SVD}-msg-{start}-{stop}-{step}.csv',
        ...
        ax[0].set_title(f'Best centroid n. for frontend-msg {v}')
...
#        ax[2].plot(K,calinski_harabasz_avg, 'gx-', label='calinski harabasz')
        ...
        plt.savefig(f'/home/ATLAS-T3/eferri/File/BestCentroid/frontend-202003{v}-{SVD}-msg-{start}-{stop}-{step}', bbox_inches ="tight")
